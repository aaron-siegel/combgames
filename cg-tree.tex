...
\def\cg@gtdrawline{{
  ...
  \else
    ...
    \else
      ...
      %\edef\cg@bracketed@node@arrow{[\cg@node@arrow]}
      %\expandafter\cg@gtdrawline@\cg@bracketed@node@arrow{(\cg@node@pname) \cg@connect node[above] {\cg@linelabel} (\cg@node@name);}
...
% \draw [\cg@node@arrow] #1 \cg@linelabel #2;
\def\cg@gtdrawline@#1#2{{
  \edef\cg@bracketed@node@arrow{[\cg@node@arrow]}
  \def\@tempsp{ }
  \edef\@tempa{[\cg@node@arrow] #1 \@tempsp\cg@linelabel\@tempsp #2;}
  \message{\@tempa}
